...
<?php 
$con=mysqli_connect("localhost","root","bshivamkumar","bus_ticket");
...
<br><br><br><br><br><br><br><br><br><br>
  ...
  <span class='footer-arrow'></span>
       <div class='footer'>	  
		  ...
		  <div class='row'>
			   <div class='col-lg-6'>
			   	<h2>About DReam Route Booking</h2>
			   	<p>DReam Route  is a registerd online bus booking website by the Our Star team. Any issues can be brought up to the judicial of the High Court.  </p>
			    <ul class='links'>
			 ...
			 <div class='footer-bottom'>
			 	...
			 	<div class='copy-right'>
			 		<p>DReam Route booking Copyright &copy; 2017  all right reserved. </p>
			 	</div>
